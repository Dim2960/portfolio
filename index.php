...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <div class="sidebar-profile">
            <!-- Photo de profil -->
            <img src="assets/images/DL_gris.png" alt="Photo de Dimitri Lefebvre" class="profile-picture" />
        ...
        <div class="sidebar-actions">
            <a href="assets/docs/CV_Dimitri_Lefebvre.pdf" class="btn btn-view-cv" target="_blank">
                <svg    xmlns="http://www.w3.org/2000/svg" 
                        width="24" 
                        height="24" 
                        viewBox="0 0 24 24" 
    ...
    <main>
        ...
        <div class="wrapper-accueil">
            ...
            <section id="accueil">
                ...
                <h3>Data Analyst</h3>
                <p>J’allie expertise technique et vision stratégique pour transformer vos données en performance. Mon expérience fait la différence.</p>
                <div>
                    <button >
        ...
        <div class="wrapper-a-propos">
            <section id="a-propos">
                <h2>À mon propos</h2>
                <p>
                    Aujourd'hui, en tant que Data Analyst certifié, j'incarne la convergence entre expertise 
                    ...
                    <br/>
                    <br/>
                    Mon parcours s'est construit sur 17 ans d'expérience au sein de BASF Division Coatings, où
        ...
        <div class="wrapper-projets">
            <section id="projets">
                <h2>Mes Projets</h2>
                <p>Une sélection de mes projets</p>
                        ...
                        <div class="carousel-track">
                            ...
                            <div class="projet-card-frame">
                                ...
                                <div class="projet-card">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <p>
                                            Analyse des données de courses NYC Taxi Services pour optimiser la répartition des taxis, la rentabilité et l'efficacité opérationnelle.
                                        </p>
                            ...
                            <div class="projet-card-frame">
                                ...
                                <div class="projet-card">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <p>
                                            Étude de marché Etatusiniens et analyse comparative des vins pour recommander un prix optimal avec des visualisations percutantes et accessibles.
                                        </p>
                            ...
                            <div class="projet-card-frame">
                                ...
                                <div class="projet-card">
                                    <!-- Zone d'image -->
                                    <div class="card-image">
                                        <img src="assets/images/projets/Taxi_NYCf.png" alt="WebApp présence" />
